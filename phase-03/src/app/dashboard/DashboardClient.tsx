      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl text-lg font-medium leading-relaxed">
            Orchestrating specialized <strong>Digital FTE</strong> autonomous agents to handle your business operations with zero human intervention.
          </p>
        </div>
