  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="p-6 border-b border-white/5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="text-xl font-bold tracking-tighter">
            Digital <span className="text-primary">FTE</span>
          </div>
        </div>
      </nav>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Ready to transform your business with <strong>Digital FTE</strong> autonomous AI agents? Send us a message and our orchestrator will analyze your needs.
              </p>
            </motion.div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-secondary/30 border border-white/5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">contact@digital-fte.com</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-secondary/30 border border-white/5">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Available 24/7 via Digital FTE agents</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
            <div className="space-y-2">
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter uppercase italic">
                Digital FTE <span className="text-primary">Projects</span>
              </h2>
            </div>
            <p className="text-muted-foreground max-w-md text-sm md:text-right">
              Explore the autonomous solutions we've built using the Digital FTE multi-agent orchestration framework.
            </p>
          </div>
      ...
      <footer className="py-12 border-t border-white/5 text-center text-muted-foreground text-sm">
        <p>© 2026 Digital FTE AI CRM Factory. All rights reserved.</p>
      </footer>
    </div>
  );
}
